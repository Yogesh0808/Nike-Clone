...
const Hero = () => {
  ...
  return (
    ...
    <p className="font-montserrat text-lg text-slate-gray leading-8 mt-6 mb-14"> Discover stylish Nike arrivals, quality Comfort , and innnovation for your active life.</p>
